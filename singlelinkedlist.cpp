...
//
//        Node *temp = Head;
//        while (temp->next != NULL && temp->next->data != current) {
//            temp = temp->next;
//        }
//
...
//
//        }
//        while(temp->next!=NULL && cur_index<index){
//            prev=temp;
//           temp= temp->next;
//           cur_index++;
//
...
//    }
//
//    void delete_item(ll itemdelete) {
//        if (is_empty()) {
...
//        } else {
//            Node *prvptr = NULL;
//            while (delptr != NULL && delptr->data != itemdelete) {
//                prvptr = delptr;
//                delptr = delptr->next;
//            }
//            if (delptr != NULL) {
...
//    }
//
//    bool iselement_equal(ll element, ll index) {
//        if (is_empty()) {
//            cout << "This list is empty\n";
//            return false;
//        }
...
//            delete delptr;
//        }
//        Head = NULL; // Resetting Head to NULL after clearing all nodes
//    }
//
//    void replaceAt(ll current_item, ll index) {
//        if (is_empty()) {
//            cout << "this list is empty\n";
//            return;
//        }
...
//         if(is_empty()){cout<<"my list is empty\n";return;}
//        if(index>=size() ){
...
//        // cout << '\n';
//        // cout << lst1.size() << '\n';
//        // cout << lst1.is_found(9) << '\n';
//        // cout << lst1.is_found(7) << '\n';
//        // lst1.insert_before(5, 26);
//        // lst1.insert_before(100, 26);
//        // lst1.append(33);
//        // lst1.delete_item(26);
//        // cout << lst1.iselement_equal(33, 7) << '\n';
//        // lst1.replaceAt(80, 2);
//
//        // Swapping elements at indices 3 and 5
////        lst1.swap(0, 6);
////        // Printing the list after swapping
////        lst1.insert_before_index(77,0);
////       lst1.delete_byindex(6);
//        lst1.print();
//        cout << '\n';
//
//     }
...
////            delete delptr;
////        }
////        Head = nullptr; // Resetting Head to nullptr after clearing all nodes
////    }
////};
////int main() {
...
////    strList.insert_first("world");
////    strList.insert_first("Hello");
////    strList.insert_first("!");
////
////    cout << "String List:\n";
////    strList.print();
////    cout << '\n';
